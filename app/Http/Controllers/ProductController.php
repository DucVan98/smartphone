...
class ProductController extends Controller
{
    ...
    public function update_product(Request $request,$product_id){
     ...
     public function details_product($product_id){
        ...
        return view('page.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('color_product',$color_product)->with('memory_product',$memory_product)->with('detail_product',$detail_product)->with('relate_product',$relate_product);
     }
}
