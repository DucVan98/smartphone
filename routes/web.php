...
Route::get('/tat-ca-san-pham', 'HomeController@all_product');
...
Route::post('/update-cart-quantyti/', 'CartController@update_cart_quantyti');

Route::post('/add-cart-ajax', 'CartController@add_cart_ajax');
Route::get('/gio-hang', 'CartController@gio_hang');

Route::post('/save-checkout/', 'CheckOutController@save_checkout_custumer');
