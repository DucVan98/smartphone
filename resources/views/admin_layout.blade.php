...
<body>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-category-blog')}}">Thêm danh mục blog</a></li>
                                <li><a href="{{URL::to('/all-category-blog')}}">Hiển thị danh mục blog</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-blog')}}">Hiển thị blog</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/user-registration')}}">Tài khoản đăng ký</a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>Design by <a href="http://w3layouts.com"> Phạm Đức Văn</a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
    ...
    <script type="text/javascript" language="javascript" src="{{asset('public/backend/ckeditor/ckeditor.js')}}"></script>
